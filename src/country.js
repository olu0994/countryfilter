...
let getCountryNames = (countryData) => {
  let countryNames = [];
  countryNames = countryData.map((countryInfo) => countryInfo.name);
  return countryNames;
};
// getCountryNames(countryData);

export default getCountryNames(countryData);
